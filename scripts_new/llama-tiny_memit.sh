python adapt_model.py --model_name "HuggingFaceM4/tiny-random-LlamaForCausalLM" --method "MEMIT" --request_file "train_dama_tiny_processed.json" --num_layers 2 --post_linear True --iterative_update True --random_seed 45

# python evaluate_model.py --model_name "HuggingFaceM4/tiny-random-LlamaForCausalLM" --num_layers 2 --method "MEMIT" --test_file test_dama.json --test_task gen
