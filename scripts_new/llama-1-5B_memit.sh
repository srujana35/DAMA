python adapt_model.py --model_name "meta-llama/Llama-3.2-1B" --method "MEMIT" --request_file "train_dama_processed.json" --num_layers 2 --post_linear True --iterative_update True --random_seed 45
...
# python evaluate_model.py --model_name "meta-llama/Llama-3.2-1B" --num_layers 2 --method "MEMIT" --test_file "anti_type1_test.txt" --test_task coref --post_linear True --iterative_update True --random_seed 45
