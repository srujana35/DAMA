python adapt_model.py --model_name "meta-llama/Llama-3.2-1B" --method "DAMA" --request_file "train_dama_tiny_processed.json" --num_layers 2 --post_linear True --iterative_update True --random_seed 45
